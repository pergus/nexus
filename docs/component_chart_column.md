...
## When to Use
Use the Chart Column component when you need to:
...
```django
{% include 'components/chart_column.html' with chart_id="my-column-chart" series_data=series_data chart_title="My Column Chart" height=380 %}
```
