...
## When to Use
Use the Form Checkbox component when you need to:
...
```django
{% include 'components/form_checkbox.html' with name="agree" label="I agree to the terms" checked=True inline=False %}
```
