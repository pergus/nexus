...
## When to Use
Use the Form File component when you need to:
...
```django
{% include 'components/form_file.html' with name="document" label="pload Document" accept=".pdf,.doc,.docx" multiple=False %}
```
