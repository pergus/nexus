...
```django
{% include 'components/chart_mixed.html' with chart_id="my-mixed-chart" series_data=series_data chart_title="My Mixed Chart" height=380 %}
```
...
| `column_width` | string | Parameter description | None |
| `curve` | string | Parameter description | None |
...
| `stacked` | string | Parameter description | None |
